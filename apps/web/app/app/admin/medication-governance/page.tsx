  ...
  return (
    <div style={{ padding: 24, maxWidth: 1100 }}>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 16 }}>
        ...
        <Link
          href="/app/admin/medication-governance/safety-evaluation"
          style={{ alignSelf: "center", fontSize: 14 }}
        >
        ...
        <Link
          href="/app/admin/medication-governance/knowledge-population"
          style={{ alignSelf: "center", fontSize: 14 }}
        >
        ...
        <Link
          href="/app/admin/medication-governance/evidence-governance"
          style={{ alignSelf: "center", fontSize: 14 }}
        >
        ...
        <Link
          href="/app/admin/medication-governance/shadow-evaluation"
          style={{ alignSelf: "center", fontSize: 14 }}
        >
        ...
        <Link
          href="/app/admin/medication-governance/recommendations"
          style={{ alignSelf: "center", fontSize: 14 }}
        >
        ...
        <Link
          href="/app/admin/medication-governance/operations-center"
          style={{ alignSelf: "center", fontSize: 14 }}
        >
          {t("medicationGovernance.openPhase18Ops")}
        </Link>
        <Link
