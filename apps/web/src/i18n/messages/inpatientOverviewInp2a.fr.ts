...
export const inpatientOverviewInp2aFr = {
  ...
  rail: {
    ...
    reviewOrdersNew: "Nouvelles / non revues",
    reviewOrdersDue: "Soins infirmiers à faire",
    reviewOrdersOverdue: "Soins infirmiers en retard",
    reviewOrdersHeld: "Ordonnances suspendues",
    reviewOrdersStat: "Ordonnances STAT / urgentes",
