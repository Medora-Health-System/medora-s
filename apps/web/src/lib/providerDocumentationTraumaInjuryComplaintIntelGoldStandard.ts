...
export function buildAnimalBiteAdultComplaintV1Intel(d: (key: string) => string): ProviderDocumentationComplaintIntelligence {
  return buildMskTraumaV1Intel(d, {
    hpi: [
      ...
      d("hpiBiteBird"),
      d("hpiBiteReptile"),
      d("hpiBiteMarineNonvenomous"),
      d("hpiBiteArthropodNonvenomous"),
      ...
      d("hpiBiteStrayWild"),
      d("hpiAnimalAvailableForObservation"),
      d("hpiAnimalUnavailable"),
...
export function buildHumanBiteHighRiskWoundAdultComplaintV1Intel(
  ...
  return buildMskTraumaV1Intel(d, {
    hpi: [
      ...
      d("hpiClenchedFist"),
      d("hpiAssault"),
      d("hpiAccidentalHumanBite"),
      d("hpiOccupationalExposure"),
      d("hpiSalivaExposure"),
      d("hpiBloodExposure"),
      d("hpiBrokenSkin"),
      d("hpiContaminatedWound"),
      d("hpiSoilContamination"),
      d("hpiFarmContamination"),
      d("hpiFreshwaterExposure"),
      d("hpiSaltwaterExposure"),
      d("hpiTetanusUpToDate"),
      d("hpiTetanusStatusUnknown"),
      d("hpiWoundPuncture"),
      d("hpiWoundDeep"),
      d("hpiDelayedPresentation"),
      d("hpiHandOrKnuckleLocation"),
      d("hpiDorsalMcpWound"),
      d("hpiToothContact"),
      d("hpiJointOrTendonConcern"),
      d("hpiImmunocompromisedOrDiabetes"),
      d("hpiBloodborneExposureDiscussed"),
    ],
    physicalExam: {
      ...
      musculoskeletal: [
        ...
        d("examTendonJointConcern"),
        d("examDecreasedRangeOfMotion"),
        d("examDorsalMcpWound"),
        d("examPainWithPassiveExtension"),
        d("examFusiformDigitSwelling"),
        d("examFlexorSheathTenderness"),
        d("examDigitHeldInFlexion"),
        d("examKanavelSignsDocumented"),
      ],
    ...
    mdmOverrides: {
      ...
      mdmDataReviewed: [d("mdmXrayReviewed"), d("mdmTetanusStatusReviewed"), d("mdmWoundCarePlanReviewed"), d("mdmBloodborneExposureReviewed")],
      mdmPlanSummary: [
        d("planWoundIrrigationCleansing"),
        d("planTetanusUpdate"),
        d("planAntibioticsDecision"),
        ...
        d("planBloodborneExposureCounseling"),
        d("planWoundCareInstructions"),
        d("planFollowUp24To48Hours"),
        d("planReturnPrecautions"),
      ],
      mdmClinicalRationale: [
        ...
        d("reasoningFightBiteHighRisk"),
        d("reasoningSmallMcpMayHideDeepInjury"),
        d("reasoningDeepInfectionConcern"),
        d("reasoningNeurovascularExamReassuring"),
      ],
