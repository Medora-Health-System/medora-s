...
export const EXTREMITY_MSK_REQUIRED_STICKY_NOTE_FRAGMENT_KEYS = [
  ...
  "providerDocumentationComplaintIntel.extremityMskComplaint.diffSprain",
  "providerDocumentationComplaintIntel.extremityMskComplaint.diffCompartmentSyndrome",
  "providerDocumentationComplaintIntel.extremityMskComplaint.rosExtremityPain",
  "providerDocumentationComplaintIntel.extremityMskComplaint.hpiShoulderPain",
