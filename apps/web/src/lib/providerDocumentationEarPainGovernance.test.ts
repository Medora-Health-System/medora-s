...
describe("providerDocumentationEarPainGovernance — MEDUI.ED.ME.2R", () => {
  ...
  it("exposes ear pain, otitis, mastoiditis, and foreign body complaint-intel chips", () => {
    ...
    expect(visible.has("providerDocumentationComplaintIntel.earPainOtitisComplaintV1.diffOtitisMedia")).toBe(true);
    ...
    expect(visible.has("providerDocumentationComplaintIntel.earPainOtitisComplaintV1.examTmFindingsIfDocumented")).toBe(
      true
    );
    expect(visible.has("providerDocumentationComplaintIntel.earPainOtitisComplaintV1.hpiForeignBodyConcern")).toBe(true);
  ...
  it("includes reinforced cannot-miss differential and disposition chips", () => {
    ...
    expect(visible.has("providerDocumentationComplaintIntel.earPainOtitisComplaintV1.diffIntracranialExtensionConcern")).toBe(
      true
    );
    expect(visible.has("providerDocumentationComplaintIntel.earPainOtitisComplaintV1.diffSepsisConcern")).toBe(true);
    expect(visible.has("providerDocumentationComplaintIntel.earPainOtitisComplaintV1.mdmCtTemporalBoneConsidered")).toBe(
      true
    );
    expect(visible.has("providerDocumentationComplaintIntel.earPainOtitisComplaintV1.mdmAdmissionIfIndicated")).toBe(
      true
    );
  ...
  it("preserves sticky-note-only activation and click-to-insert", () => {
    ...
    const fragmentKey = "providerDocumentationComplaintIntel.earPainOtitisComplaintV1.diffOtitisMedia";
  ...
  it("reinforces full MDM stack on ear pain complaint intelligence", () => {
    ...
    expect(EAR_PAIN_OTITIS_COMPLAINT_V1_INTEL.mdmImmediateActionsRationale?.length).toBeGreaterThan(0);
