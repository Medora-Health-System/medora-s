 ...
 *
 * Discovery note: governed template is `dehydration_viral_illness_complaint_v1` (adult).
 * Related but out-of-scope IDs: legacy `dehydration` (pediatric), `dehydration_metabolic_complaint_v1`
 * (endocrine/metabolic). No `viral_illness_complaint_v1` or `gastroenteritis_dehydration_complaint_v1`.
 */
