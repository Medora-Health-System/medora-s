...
export const RASH_REQUIRED_STICKY_NOTE_FRAGMENT_KEYS = [
  "providerDocumentationComplaintIntel.allergicReactionRash.hpiRashOnsetReviewed",
  "providerDocumentationComplaintIntel.allergicReactionRash.hpiMedicationExposureReviewed",
  "providerDocumentationComplaintIntel.allergicReactionRash.hpiInsectStingReviewed",
  ...
  "providerDocumentationComplaintIntel.rashSkinComplaintV1.hpiExposuresMedication",
  "providerDocumentationComplaintIntel.rashSkinComplaintV1.rfPurpuraConcern",
  "providerDocumentationComplaintIntel.rashSkinComplaintV1.diffAllergicReaction",
  "providerDocumentationComplaintIntel.rashSkinComplaintV1.mdmAntihistamineSteroidPlanIfGiven",
