...
export const SHORTNESS_OF_BREATH_REQUIRED_STICKY_NOTE_FRAGMENT_KEYS = [
  ...
  "providerDocumentationComplaintIntel.sob.hpiSuddenOnsetShortnessOfBreath",
  ...
  "providerDocumentationComplaintIntel.sob.examDiffuseWheezing",
  ...
  "providerDocumentationComplaintIntel.sob.diffHeartFailureExacerbation",
  "providerDocumentationComplaintIntel.sob.diffPneumonia",
  "providerDocumentationComplaintIntel.sob.diffPulmonaryEmbolism",
  "providerDocumentationComplaintIntel.sob.waLowSuspicionPulmonaryEmbolism",
