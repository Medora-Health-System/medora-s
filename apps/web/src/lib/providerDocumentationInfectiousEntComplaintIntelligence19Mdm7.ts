...
export const EAR_PAIN_OTITIS_COMPLAINT_V1_INTEL: ProviderDocumentationComplaintIntelligence = intel({
  hpi: [earPainOtitis("hpiOnsetHearingDrainageFever"), earPainOtitis("hpiUriSymptoms"), earPainOtitis("hpiMastoidPainDizziness")],
  rosImportantPositives: [earPainOtitis("rosEarPain"), earPainOtitis("rosHearingChange"), earPainOtitis("rosFever")],
  rosImportantNegatives: [earPainOtitis("rosDeniesMastoidSwelling")],
  rosRedFlags: [earPainOtitis("rfMastoiditisConcern"), earPainOtitis("rfSevereEarPain")],
  physicalExam: { skin: [earPainOtitis("examTmFindingsIfDocumented"), earPainOtitis("examMastoidTendernessIfDocumented"), earPainOtitis("examExternalEarFindingsIfDocumented")], general: [earPainOtitis("examGeneralAppearance")] },
  mdmWorkingAssessment: [earPainOtitis("mdmEarPainPresentation")],
  mdmDifferentialSynthesis: [earPainOtitis("diffOtitisMedia"), earPainOtitis("diffOtitisExterna"), earPainOtitis("diffMastoiditisConcern"), earPainOtitis("diffDentalTmjReferredPain")],
  mdmDataReviewed: [earPainOtitis("mdmLabsReviewedIfObtained")],
  mdmClinicalRationale: [earPainOtitis("mdmAntibioticPlanIfGiven"), earPainOtitis("mdmEntFollowUpIfIndicated")],
  mdmAdmitObserveDischarge: [earPainOtitis("mdmObservationIfHighRisk")],
  reassessment: [earPainOtitis("reassessPainHearing")],
  followUpDisposition: [earPainOtitis("dispReturnWorseningPainSwellingFever")],
});
