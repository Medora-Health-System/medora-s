...
export const HEADACHE_REQUIRED_STICKY_NOTE_FRAGMENT_KEYS = [
  ...
  "providerDocumentationComplaintIntel.headache.hpiSuddenOnsetHeadache",
  "providerDocumentationComplaintIntel.headache.hpiVisualDisturbance",
  "providerDocumentationComplaintIntel.headache.rfWorstHeadacheOfLife",
  "providerDocumentationComplaintIntel.headache.rfFocalNeurologicDeficit",
  ...
  "providerDocumentationComplaintIntel.headache.mdmLumbarPunctureReviewed",
  "providerDocumentationComplaintIntel.headache.dispNeurologyFollowUpRecommended",
  "providerDocumentationComplaintIntel.migraineHeadacheComplaintV1.diffMigraine",
  "providerDocumentationComplaintIntel.migraineHeadacheComplaintV1.rfWorstHeadacheOfLife",
  "providerDocumentationComplaintIntel.migraineHeadacheComplaintV1.hpiPhotophobia",
