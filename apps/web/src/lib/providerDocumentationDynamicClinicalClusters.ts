...
export const DYNAMIC_CLINICAL_CLUSTER_DEFINITIONS: ClusterDefinition[] = [
  ...
  },
  {
    ...
    suggestions: [
      ...
      sug("disposition", stroke("dispTransferredHigherLevelCare"), "mdmAdmitObserveDischarge"),
      sug("disposition", stroke("dispAdmittedNeurologicMonitoring"), "mdmAdmitObserveDischarge"),
    ],
  },
  {
    id: "surgical_abdomen",
