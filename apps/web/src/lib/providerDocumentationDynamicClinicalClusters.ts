...
export const DYNAMIC_CLINICAL_CLUSTER_DEFINITIONS: ClusterDefinition[] = [
  ...
  },
  {
    ...
    suggestions: [
      ...
      sug("mdm", stroke("reasoningCtaObtainedForLvo"), "mdmClinicalRationale"),
      sug("mdm", stroke("mdmCtaHeadNeckReviewed"), "mdmDataReviewed"),
      sug("mdm", stroke("planNeurologyConsulted"), "mdmPlanSummary"),
      sug("reassessment", stroke("reassessNeuroExamUnchanged"), "mdmPlanSummary"),
      sug("reassessment", clusterFrag("airwaySwallowReassessmentPerformed"), "mdmPlanSummary"),
      sug("disposition", stroke("planTransferArranged"), "mdmPlanSummary"),
      sug("disposition", stroke("dispAdmittedStrokeEvaluation"), "followUpDisposition"),
    ],
  },
  {
    id: "surgical_abdomen",
  ...
  },
  {
    ...
    suggestions: [
      sug("differential", psych("diffImminentSuicideRisk"), "mdmDifferentialSynthesis"),
      sug("disposition", psych("dispInvoluntaryHoldInitiated"), "mdmAdmitObserveDischarge"),
      sug("mdm", psych("planBehavioralHealthConsulted"), "mdmPlanSummary"),
      sug("mdm", psych("planSuicidePrecautionsInitiated"), "mdmPlanSummary"),
      sug("mdm", psych("reasoningSafetyPrecautionsAppropriate"), "mdmClinicalRationale"),
      sug("reassessment", psych("reassessCalmAndCooperative"), "mdmPlanSummary"),
      sug("reassessment", psych("reassessSafetyContractMaintained"), "mdmPlanSummary"),
      sug("disposition", psych("planPsychiatricAdmissionArranged"), "mdmAdmitObserveDischarge"),
      sug("disposition", psych("dispDischargedWithSafetyPlan"), "mdmAdmitObserveDischarge"),
    ],
  },
  {
