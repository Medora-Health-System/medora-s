...
export const DYNAMIC_CLINICAL_CLUSTER_DEFINITIONS: ClusterDefinition[] = [
  ...
  },
  {
    ...
    suggestions: [
      ...
      sug("reassessment", cp("reassessChestPainImproved"), "mdmPlanSummary"),
      sug("reassessment", cp("reassessSerialReassessmentPerformed"), "mdmPlanSummary"),
      sug("disposition", cp("mdmAdmissionConsidered"), "mdmAdmitObserveDischarge"),
  ...
  },
  {
    ...
    suggestions: [
      ...
      sug("reassessment", femaleGyn("reassessVitalsStable"), "mdmPlanSummary"),
  ...
  },
  {
    ...
    suggestions: [
      sug("differential", back("diffCaudaEquinaSyndrome"), "mdmDifferentialSynthesis"),
      ...
      sug("mdm", back("mdmNeurologicRedFlagsAssessed"), "mdmClinicalRationale"),
      sug("reassessment", back("reassessNeurologicExamUnchanged"), "mdmPlanSummary"),
      sug("reassessment", back("reassessAmbulationReassessed"), "mdmPlanSummary"),
      sug("disposition", back("dispAdmissionConsultConsideredIfNeurologicDeficitOrImagingAbnormality"), "mdmAdmitObserveDischarge"),
    ],
  },
];
