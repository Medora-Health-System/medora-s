...
export const BACK_PAIN_REQUIRED_STICKY_NOTE_FRAGMENT_KEYS = [
  ...
  "providerDocumentationComplaintIntel.backPainTrauma.hpiRadiationToLegReviewed",
  "providerDocumentationComplaintIntel.backPainTrauma.hpiBowelBladderSymptomsReviewed",
  "providerDocumentationComplaintIntel.backPainTrauma.hpiSaddleAnesthesiaReviewed",
  "providerDocumentationComplaintIntel.backPainTrauma.rosLegPain",
  "providerDocumentationComplaintIntel.backPainTrauma.rfNeurologicDeficit",
  "providerDocumentationComplaintIntel.backPainTrauma.rfSaddleAnesthesia",
  "providerDocumentationComplaintIntel.backPainTrauma.examThoracicLumbarTenderness",
  ...
  "providerDocumentationComplaintIntel.backPainComplaintV1.hpiRadiationWeaknessNumbness",
