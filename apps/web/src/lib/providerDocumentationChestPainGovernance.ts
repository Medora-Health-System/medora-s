...
export const CHEST_PAIN_REQUIRED_STICKY_NOTE_FRAGMENT_KEYS = [
  ...
  "providerDocumentationComplaintIntel.chestPain.hpiPainRadiatesToLeftArm",
  ...
  "providerDocumentationComplaintIntel.chestPain.diffPulmonaryEmbolism",
  "providerDocumentationComplaintIntel.chestPain.mdmEkgReviewed",
  "providerDocumentationComplaintIntel.chestPain.mdmTroponinReviewed",
  "providerDocumentationComplaintIntel.chestPain.waLowSuspicionPulmonaryEmbolism",
