...
export const DIZZINESS_VERTIGO_REQUIRED_STICKY_NOTE_FRAGMENT_KEYS = [
  ...
  "providerDocumentationComplaintIntel.dizzinessSyncope.hpiTrueVertigo",
  "providerDocumentationComplaintIntel.dizzinessSyncope.hpiSyncopeEvent",
  "providerDocumentationComplaintIntel.dizzinessSyncope.diffPosteriorStroke",
  "providerDocumentationComplaintIntel.dizzinessSyncope.diffBppv",
  "providerDocumentationComplaintIntel.dizzinessSyncope.mdmEcgReviewed",
  "providerDocumentationComplaintIntel.dizzinessSyncope.mdmCtHeadIfIndicated",
  "providerDocumentationComplaintIntel.vertigoComplaintV1.rosVertigo",
  "providerDocumentationComplaintIntel.vertigoComplaintV1.diffPeripheralVertigo",
  "providerDocumentationComplaintIntel.nearSyncopeComplaintV1.rosNearSyncope",
  "providerDocumentationComplaintIntel.nearSyncopeComplaintV1.diffArrhythmia",
