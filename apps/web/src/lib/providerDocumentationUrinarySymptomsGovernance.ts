...
export const URINARY_SYMPTOMS_REQUIRED_STICKY_NOTE_FRAGMENT_KEYS = [
  ...
  "providerDocumentationComplaintIntel.utiUrinarySymptoms.hpiHematuriaReviewed",
  "providerDocumentationComplaintIntel.utiUrinarySymptoms.hpiFlankPainReviewed",
  "providerDocumentationComplaintIntel.utiUrinarySymptoms.hpiSuprapubicPain",
  "providerDocumentationComplaintIntel.utiUrinarySymptoms.examCvaTenderness",
