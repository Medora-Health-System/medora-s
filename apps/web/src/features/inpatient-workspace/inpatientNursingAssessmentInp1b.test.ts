...
describe("INP.1B inpatient nursing UI isolation",()=>{
  ...
  it("has complete EN/FR catalogs",()=>{expect(read("i18n/messages/inpatientNursingAssessmentInp1b.en.ts")).toContain('title: "Nursing Assessment"');expect(read("i18n/messages/inpatientNursingAssessmentInp1b.fr.ts")).toContain('title: "Évaluation infirmière"');});
