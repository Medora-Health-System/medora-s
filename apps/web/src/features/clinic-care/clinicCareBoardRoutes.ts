/**
 * MEDUI.D4C.2A.1 — ambulatory board patient-name → chart navigation.
...
/**
 * Primary patient-name destination from Clinic Care trackboard.
 * Closed → patient chart; open → generic encounter chart (shared enterprise).
