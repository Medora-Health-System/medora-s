...
const TAB_BY_CATEGORY: Record<AiSuggestionCategory, TabId> = {
  CLINICAL_SAFETY: "safety", DIAGNOSTIC_GAP: "diagnostics", RESULT_FOLLOWUP: "diagnostics",
  MEDICATION_CONSIDERATION: "treatment", ORDER_CONSIDERATION: "treatment", REASSESSMENT_GAP: "documentation",
  DOCUMENTATION_GAP: "documentation", MDM_GAP: "documentation", DISPOSITION_GAP: "discharge",
  DISCHARGE_SAFETY: "discharge", FOLLOW_UP_GAP: "discharge", CONTRADICTION: "safety",
  DUPLICATION: "treatment", PENDING_ACTION: "diagnostics",
};
const SECTION_BY_CATEGORY: Partial<Record<AiSuggestionCategory, ClinicCareAmbulatoryWorkspaceSection>> = {
  CLINICAL_SAFETY: "results", DIAGNOSTIC_GAP: "results", RESULT_FOLLOWUP: "results",
  MEDICATION_CONSIDERATION: "medications", ORDER_CONSIDERATION: "orders", REASSESSMENT_GAP: "medical-evaluation",
  DOCUMENTATION_GAP: "notes", MDM_GAP: "medical-evaluation", DISPOSITION_GAP: "summary",
  DISCHARGE_SAFETY: "summary", FOLLOW_UP_GAP: "follow-up", CONTRADICTION: "medical-evaluation",
  DUPLICATION: "orders", PENDING_ACTION: "results",
};
...
export function AiChartReviewPanel({ encounterId, facilityId, language, onNavigate }: {
  encounterId: string;
  facilityId: string;
  language: string;
  ...
  return (
    <aside aria-label={copy.title} data-testid="ai-chart-review-panel" data-read-only="true" style={{
