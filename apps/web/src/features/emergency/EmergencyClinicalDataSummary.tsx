...
export function EmergencyClinicalDataSummary({
  ...
  if (!hasSummaryContent) {
    return (
      <section data-testid="emergency-clinical-data-summary" style={cardShell}>
    ...
    <section data-testid="emergency-clinical-data-summary" style={cardShell}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8, flex: 1, minHeight: 0 }}>
            ...
            {section.metrics.map((metric) => {
              ...
              return (
                ...
                >
                  ...
                  {inlineDetails ? (
                    <div
                      data-testid="clinical-data-summary-metric-inline"
        ...
        {!projection.intakeOutput.insufficientData ? (
          <article data-testid="clinical-data-summary-section-intake_output">
            <p style={{ margin: "0 0 2px", fontSize: 11, fontWeight: 600, color: "#64748b" }}>
              {t("emergencyClinicalData.summary.sections.intakeOutput")}
            </p>
            {projection.intakeOutput.totalIntakeMl != null ? (
              <div style={{ fontSize: 11, padding: "1px 0" }}>
