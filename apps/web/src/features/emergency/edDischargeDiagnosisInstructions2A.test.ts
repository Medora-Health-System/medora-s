...
describe("MEDUI.ED.DISCHARGE.DIAGNOSIS_INSTRUCTIONS.2A", () => {
  describe("CoverageAuditLevel2", () => {
    ...
    it("2 — counts specific vs generic fallback", () => {
      ...
      // Phase 15: 225 picker records; Phase 16 toxicology adds 20 (225 -> 245); Phase 17 OB/GYN/urology adds 40 (245 -> 285); Phase 18 psychiatric/behavioral adds 20 (285 -> 305).
      expect(audit.summary.totalPickerRecordsAudited).toBe(305);
      expect(audit.summary.totalGenericFallbackOnly).toBe(0);
      expect(audit.summary.totalDiagnosisSpecificMapped).toBe(305);
    });
