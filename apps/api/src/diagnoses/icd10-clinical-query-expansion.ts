...
export const ICD10_CLINICAL_QUERY_EXPANSIONS: Icd10QueryExpansion[] = [
  ...
  { query: "ramsay hunt", anyOf: ["Postherpetic geniculate ganglionitis", "zoster with other nervous system involvement"] },
  { query: "herpes zoster oticus", anyOf: ["Postherpetic geniculate ganglionitis", "zoster with other nervous system involvement"] },
  { query: "syndrome de ramsay hunt", anyOf: ["Postherpetic geniculate ganglionitis", "zoster with other nervous system involvement"] },
