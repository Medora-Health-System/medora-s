...
export const FHIR_RESOURCE_TYPES = ["Patient", "Encounter", "Observation", "Condition", "ServiceRequest", "DiagnosticReport", "CarePlan", "Organization", "Location", "Practitioner", "PractitionerRole", "Provenance"] as const;
