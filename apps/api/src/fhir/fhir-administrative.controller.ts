...
@Controller("fhir/Practitioner") @UseGuards(...guards) @UseFilters(FhirOperationOutcomeFilter) @UseInterceptors(...interceptors)
...
@Controller("fhir/PractitionerRole") @UseGuards(...guards) @UseFilters(FhirOperationOutcomeFilter) @UseInterceptors(...interceptors)
...
@Controller("fhir/Organization") @UseGuards(...guards) @UseFilters(FhirOperationOutcomeFilter) @UseInterceptors(...interceptors)
...
@Controller("fhir/Location") @UseGuards(...guards) @UseFilters(FhirOperationOutcomeFilter) @UseInterceptors(...interceptors)
