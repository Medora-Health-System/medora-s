...
@Controller("fhir/Practitioner") @UseGuards(...guards) @UseFilters(FhirOperationOutcomeFilter) @UseInterceptors(FhirMediaInterceptor, FhirMachineAuditInterceptor)
...
@Controller("fhir/PractitionerRole") @UseGuards(...guards) @UseFilters(FhirOperationOutcomeFilter) @UseInterceptors(FhirMediaInterceptor, FhirMachineAuditInterceptor)
...
@Controller("fhir/Organization") @UseGuards(...guards) @UseFilters(FhirOperationOutcomeFilter) @UseInterceptors(FhirMediaInterceptor, FhirMachineAuditInterceptor)
...
@Controller("fhir/Location") @UseGuards(...guards) @UseFilters(FhirOperationOutcomeFilter) @UseInterceptors(FhirMediaInterceptor, FhirMachineAuditInterceptor)
