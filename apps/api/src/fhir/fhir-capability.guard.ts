...
export type RequiredFhirCapability = { resourceType: import("./fhir-capability.registry").FhirCapability["resourceType"] | ":type"; interaction: FhirInteraction };
...
export class FhirCapabilityGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean {
    ...
    const resourceType = required.resourceType === ":type" ? request.params?.type : required.resourceType;
