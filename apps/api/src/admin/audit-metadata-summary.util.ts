...
const SAFE_METADATA_KEYS = new Set([
  ...
  "deficiencyCodes",
  /** MEDUI.D4C.7J — advisory closure acknowledgement (counts / codes only, no PHI). */
  "advisoryAcknowledged",
  "acknowledgementReason",
  "acknowledgementSource",
  "priorityWarningCategories",
  "pendingClinicalItemsPreserved",
  "clientRequestId",
  ...
  "orderId",
  "orderItemId",
  "enterpriseOrderSetCode",
  "enterpriseOrderSetVersion",
  "enterpriseOrderSetCategory",
  "enterpriseOrderSetClinicalDomain",
  "enterpriseOrderSetSelectedItemCount",
  "enterpriseOrderSetSkippedItemCount",
  "enterpriseOrderSetStructuredParameterSkippedCount",
  "enterpriseOrderSetAppliedSurface",
  "enterpriseOrderSetAppliedAt",
