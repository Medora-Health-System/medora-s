...
export class PrivilegedActionController {
  ...
  @Post() @RequirePlatformCapabilities(["STAFF_PROVISION","STAFF_GRANT_CAPABILITIES"],{mode:"ANY",requireRecentMfa:true})
  ...
  @Get() @RequirePlatformCapabilities(["STAFF_VIEW","PRIVILEGED_ACTION_APPROVE"],{mode:"ANY",requireRecentMfa:true})
  ...
  @Get(":id") @RequirePlatformCapabilities(["STAFF_VIEW","PRIVILEGED_ACTION_APPROVE"],{mode:"ANY",requireRecentMfa:true})
  ...
  @Post(":id/cancel") @RequirePlatformCapabilities(["STAFF_PROVISION","STAFF_GRANT_CAPABILITIES"],{mode:"ANY"})
  ...
  @Post(":id/execute") @RequirePlatformCapabilities(["STAFF_PROVISION","STAFF_GRANT_CAPABILITIES"],{mode:"ANY",requireRecentMfa:true})
