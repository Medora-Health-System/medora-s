...
export class PlatformStaffController {
  ...
  @Post("staff/:id/provision") @RequirePlatformCapabilities(["STAFF_PROVISION"], { requireRecentMfa: true, denialAudit: { event: "STAFF_MUTATION_DENIED", sourceOperation: "platform.staff.provision", requestedCapabilityFrom: "NONE" } })
  ...
  @Post("staff/:id/capabilities") @RequirePlatformCapabilities(["STAFF_GRANT_CAPABILITIES"], { requireRecentMfa: true, denialAudit: { event: "PLATFORM_CAPABILITY_GRANT_DENIED", sourceOperation: "platform.staff.capability.grant", requestedCapabilityFrom: "BODY" } })
