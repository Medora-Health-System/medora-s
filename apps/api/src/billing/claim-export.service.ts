...
export class ClaimExportService {
  ...
  async buildEncounterClaimExport(facilityId: string, encounterId: string): Promise<EncounterClaimExportResult> {
    ...
    const profHeader: ClaimExportHeader = {
      ...
      ready: completeness.professionalClaimReady && packageReady(profLines.length > 0, v.professional.blockers),
    ...
    const facHeader: ClaimExportHeader = {
      ...
      facilityId,
      claimType: "FACILITY",
      ready: completeness.facilityClaimReady && packageReady(facLines.length > 0, v.facility.blockers),
    ...
    return {
      ...
      summary: {
        ...
        professionalClaimReady: completeness.professionalClaimReady,
        professionalClaimBlockers: completeness.professionalClaimBlockers,
        professionalClaimWarnings: completeness.professionalClaimWarnings,
        professionalClaimInfo: completeness.professionalClaimInfo,
        facilityClaimReady: completeness.facilityClaimReady,
        facilityClaimBlockers: completeness.facilityClaimBlockers,
        facilityClaimWarnings: completeness.facilityClaimWarnings,
        facilityClaimInfo: completeness.facilityClaimInfo,
        resolvedRenderingProviderUserId: roleResolution.renderingProviderUserId,
        resolvedBillingProviderUserId: roleResolution.billingProviderUserId,
