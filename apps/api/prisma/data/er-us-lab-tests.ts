...
export const US_ER_LAB_CATALOG: UsErLabCatalogRow[] = [
  ...
  },
  {
    ...
    // CLFS pending: parsed CLFS only matched breath ethanol (82075), not blood ethanol.
