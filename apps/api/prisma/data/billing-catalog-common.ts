...
export const IMAGING_CODE_TO_CPT: Record<string, { cpt: string; description: string; billClass: "facility" | "professional" }> = {
  ...
  CT_HEAD_WO_CONTRAST: { cpt: "70450", description: "CT head w/o contrast (example)", billClass: "facility" },
  ...
  US_ABDOMEN: { cpt: "76700", description: "US exam, abdomen, complete (example)", billClass: "facility" },
  ...
  US_VENOUS_DOPPLER_LE: { cpt: "93971", description: "Duplex scan, venous, extremity (example)", billClass: "facility" },
