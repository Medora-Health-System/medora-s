...
CREATE TABLE "interop"."FhirIntegrationRateLimitBucket" (
  "id" TEXT NOT NULL,
  "clientId" TEXT NOT NULL,
  "facilityId" TEXT NOT NULL,
...
CREATE INDEX "IntegrationClientScope_capabilityCode_idx" ON "interop"."IntegrationClientScope"("capabilityCode");
...
CREATE UNIQUE INDEX "FhirIntegrationRateLimitBucket_clientId_facilityId_windowStart_key" ON "interop"."FhirIntegrationRateLimitBucket"("clientId", "facilityId", "windowStart");
CREATE INDEX "FhirIntegrationRateLimitBucket_windowStart_idx" ON "interop"."FhirIntegrationRateLimitBucket"("windowStart");
...
ALTER TABLE "interop"."FhirIntegrationRateLimitBucket" ADD CONSTRAINT "FhirIntegrationRateLimitBucket_facilityId_fkey" FOREIGN KEY ("facilityId") REFERENCES "public"."Facility"("id") ON DELETE CASCADE ON UPDATE CASCADE;
