    ...
    for (const facility of facilities) {
        ...
        await prisma.protocolOrderSet.updateMany({
            where: {
                ...
                pathwayType: client_1.PathwayType.STROKE,
                isActive: true,
            },
            data: { isActive: false },
        });
                ...
                items: {
                    create: [
                        ...(labTests.slice(0, 3).map((test, idx) => ({
                            ...
                            priority: client_1.OrderPriority.STAT,
                            sequence: idx + 1,
        ...
        await prisma.protocolOrderSet.updateMany({
            where: {
                facilityId: facility.id,
                pathwayType: client_1.PathwayType.SEPSIS,
                isActive: true,
            },
            data: { isActive: false },
        });
        ...
        await prisma.protocolOrderSet.updateMany({
            where: {
                facilityId: facility.id,
                pathwayType: client_1.PathwayType.STEMI,
                isActive: true,
            },
            data: { isActive: false },
        });
        ...
        await prisma.protocolOrderSet.updateMany({
            where: {
                facilityId: facility.id,
                pathwayType: client_1.PathwayType.TRAUMA,
                isActive: true,
            },
            data: { isActive: false },
        });
...
//# sourceMappingURL=seed-pathways.js.map