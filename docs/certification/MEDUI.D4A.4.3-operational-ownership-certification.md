...
> **Note (2026-08-16):** File relocated from `MEDUI.D4A.4.3-certification.md` so the
> Hospital Bed Management Consolidation milestone can use that path.
> This document remains the ownership-completion certificate.
