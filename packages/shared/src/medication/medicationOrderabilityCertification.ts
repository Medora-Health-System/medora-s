...
import { ENTERPRISE_ONCOLOGY_FORMULARY_MANIFEST } from "./enterpriseOncologyFormularyManifest.js";
...
import { ENTERPRISE_PSYCHIATRY_FORMULARY_MANIFEST } from "./enterprisePsychiatryFormularyManifest.js";
import {
...
export function buildUnifiedOrderabilityMap(): Map<string, MedicationOrderabilityRecord> {
  ...
  const enterpriseEntries = [
    ...
    ...ENTERPRISE_ONCOLOGY_FORMULARY_MANIFEST,
    ...
    ...ENTERPRISE_PSYCHIATRY_FORMULARY_MANIFEST,
  ] as EnterpriseLike[];
