...
export const HIGH_ALERT_MEDICATION_GOVERNANCE_MANIFEST: HighAlertMedicationGovernanceEntry[] = [
  ...
  // --- VASOPRESSOR enterprise Wave4 alignment (M1.8B.7E.2C.3) ---
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 dopamine drip (Haiti parity)",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 dopamine high-concentration drip",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 dobutamine vial (Haiti parity)",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 dobutamine premix bag",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 norepinephrine vial (Haiti parity)",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 norepinephrine premix bag",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 norepinephrine high-concentration premix",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 phenylephrine vial (Haiti parity)",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 phenylephrine premix bag",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 vasopressin vial (Haiti parity)",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 vasopressin premix bag",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 epinephrine push (generic Epinephrine parity)",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 epinephrine infusion drip",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 epinephrine premix bag",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 epinephrine high-concentration premix",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 milrinone (temporary VASOPRESSOR until INOTROPE class)",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  {
    ...
    safetyRequirementCodes: VASOPRESSOR_REQS,
    governanceStatus: "APPLY",
    rationale: "Enterprise Wave4 milrinone premix bag (temporary VASOPRESSOR until INOTROPE class)",
    sourcePhase: "M1.8B.7E.2C.3",
    manualReview: false,
  },
  // --- ANTIARRHYTHMIC ---
