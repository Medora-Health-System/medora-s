...
export const CLINICAL_LAB_PANEL_SCAFFOLDS: Record<ClinicalLabPanelKey, ClinicalLabPanelScaffoldRow[]> = {
  CBC: [
    { code: "WBC", name: "White Blood Cell (WBC)", unit: "10^9/L" },
    { code: "RBC", name: "Red Blood Cell (RBC)", unit: "10^12/L" },
    { code: "HGB", name: "Hemoglobin (Hgb)", unit: "g/dL" },
    { code: "HCT", name: "Hematocrit (Hct)", unit: "%" },
    { code: "PLT", name: "Platelet (Plt)", unit: "10^9/L" },
    ...
    { code: "NEUTROPHILS_ABS", name: "Neutrophils Absolute", unit: "10^9/L" },
    { code: "LYMPHOCYTES_ABS", name: "Lymphocytes Absolute", unit: "10^9/L" },
    { code: "MONOCYTES_ABS", name: "Monocytes Absolute", unit: "10^9/L" },
    { code: "EOSINOPHILS_ABS", name: "Eosinophils Absolute", unit: "10^9/L" },
    { code: "BASOPHILS_ABS", name: "Basophils Absolute", unit: "10^9/L" },
  ],
  CMP: [
    { code: "GLU", name: "Glucose", unit: "mg/dL" },
    { code: "BUN", name: "Blood Urea Nitrogen (BUN)", unit: "mg/dL" },
    { code: "CREAT", name: "Creatinine", unit: "mg/dL" },
    { code: "EGFR", name: "Estimated GFR (eGFR)", unit: "mL/min/BSA" },
    { code: "NA", name: "Sodium", unit: "mmol/L" },
    { code: "K", name: "Potassium", unit: "mmol/L" },
    { code: "CL", name: "Chloride", unit: "mmol/L" },
    { code: "CO2", name: "Carbon Dioxide (CO2)", unit: "mmol/L" },
