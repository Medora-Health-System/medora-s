export const CLINICAL_DOCUMENTATION_CATEGORIES = [
  ...
  "BELONGINGS_VALUABLES_DOCUMENTATION",
  "PROCEDURE_MONITORING",
  "PAIN_DOCUMENTATION",
  "NEUROLOGICAL_DOCUMENTATION",
  "FALL_RISK_AND_SAFETY",
  "DEVICE_LINE_TUBE_DRAIN_MONITORING",
  "SEPSIS_MONITORING_DOCUMENTATION",
  "NURSING_ADMISSION_AND_CARE_PLAN",
  "SKIN_WOUND_PRESSURE_INJURY",
  "DIALYSIS_RENAL_FLUID_MANAGEMENT",
  "PATIENT_EDUCATION_AND_DISCHARGE_TEACHING",
] as const;
