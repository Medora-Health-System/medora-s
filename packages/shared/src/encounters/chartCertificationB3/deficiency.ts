...
const RULE_VERSION = "b3-1.0.0";

export function makeB3Deficiency(input: {
  stableCode: string;
  ...
  return {
    ...
    module: input.module,
    titleKey: `edLifecycle.certification.b3.codes.${input.stableCode}.title`,
    descriptionKey: `edLifecycle.certification.b3.codes.${input.stableCode}.description`,
    owner: input.owner,
