...
export const CHART_CERTIFICATION_ROOT_CODES = {
  ...
  /** Communication acknowledgment — must not collapse into content-missing. */
  DISCHARGE_INSTRUCTIONS_NOT_COMMUNICATED: "DISCHARGE_INSTRUCTIONS_NOT_COMMUNICATED",
} as const;
...
const DEDUPE_ALIASES: Record<string, string> = {
  ...
  "disposition:DISCHARGE_INSTRUCTIONS_NOT_GIVEN":
    CHART_CERTIFICATION_ROOT_CODES.DISCHARGE_INSTRUCTIONS_NOT_COMMUNICATED,
