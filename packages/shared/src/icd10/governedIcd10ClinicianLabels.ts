...
export type GovernedIcd10DisplayMaps = {
  ...
  es: Readonly<Record<string, string>>;
};

export const GOVERNED_ICD10_CLINICIAN_LABELS_FR: Readonly<Record<string, string>> = {
...
export const GOVERNED_ICD10_CLINICIAN_LABELS_ES: Readonly<Record<string, string>> = {
...
export const GOVERNED_ICD10_CLINICIAN_LABELS: GovernedIcd10DisplayMaps = {
  fr: GOVERNED_ICD10_CLINICIAN_LABELS_FR,
  es: GOVERNED_ICD10_CLINICIAN_LABELS_ES,
};
